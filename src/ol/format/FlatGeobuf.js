 ...
 *
  * @api
 */
class FlatGeobuf extends FeatureFormat {
  ...
  readFeatures(source, opt_options) {
    const geojson = flatgeobuf.deserialize(new Uint8Array(source))
    return this.readFeaturesFromObject(geojson, this.getReadOptions(source, opt_options));
  }
